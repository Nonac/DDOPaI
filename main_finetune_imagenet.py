...
parser.add_argument('-data', metavar='DIR',default='/home/lab4y/nvme/Datasets/imagenet',
...
parser.add_argument('--resume_pruned', default='./runs/pruning/imagenet/resnet50/imagenet_resnet18_to_resnet50_COP_prune_ratio_95/ss_10000_0.3/prune_imagenet_resnet5050_r0.95_it0.pth.tar',
                    type=str, metavar='PATH',
...
parser.add_argument('--dist-url', default='tcp://127.0.0.1:12367', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.resume_pruned:
        if os.path.isfile(args.resume_pruned):
            ...
            checkpoint = torch.load(args.resume_pruned, map_location='cpu')
