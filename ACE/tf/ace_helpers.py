...
from ACE.tf.vgg16 import VGG16Wrapper_public
from ACE.tf.resnet50 import ResNet50Wrapper_public
  ...
  """
    if model_to_run == 'InceptionV3':
        ...
        mymodel = model.GoogleNetWrapper_public(
            sess, model_saved_path=model_path, labels_path=labels_path)
    elif model_to_run == 'vgg16':
        mymodel = VGG16Wrapper_public(
            sess, model_saved_path=model_path, labels_path=labels_path)
    elif model_to_run == 'resnet50':
        mymodel = ResNet50Wrapper_public(
            sess, model_saved_path=model_path, labels_path=labels_path)
    else:
