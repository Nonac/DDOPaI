...
class VGG16Wrapper_public(KerasModelWrapper):
    def __init__(self, sess, model_saved_path, labels_path):
        self.image_value_range = (-1, 1)
        self.sess = sess

        super(VGG16Wrapper_public, self).__init__(
            sess,
            model_saved_path,
            labels_path)
        self.model_name = 'vgg16_bn_pretrained'
        self.label_txt = '/home/lab4y/nvme/Datasets/imagenet_100/imagenet1000_clsidx_to_labels.txt'
