# Based on code taken from https://github.com/pytorch/vision/blob/main/torchvision/models/mobilenetv2.py
...
class ConvBNActivation(nn.Sequential):
    def __init__(
        ...
        super().__init__(
            layers.Conv2d(in_planes, out_planes, kernel_size, stride, padding, dilation=dilation, groups=groups,
                          bias=False),
